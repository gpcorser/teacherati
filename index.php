...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
    <head>
        ...
        <meta name="author" content="Bradley Chippi">
    ...
    <body id="page-top">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-8 col-lg-offset-2 text-center">
                        <h2 class="section-heading shadow">We've got what you need!</h2>
                        <hr class="light">
                        <p class="shadow">Teacherati has everything you need to get your class started or up to date! With our repository full of usefull material regarding Emerging Technology, we plan to change the way we collaborate as students and teachers.</p>
                        <!--SHADOW BOX LOGIN-->
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-6 text-center">
                        <div class="service-box">
                            ...
                            <h3>Sturdy Lessons</h3>
                            <p class="text-muted">Our lessons are updated regularly so they don't get out-dated.</p>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 text-center">
                        <div class="service-box">
                            ...
                            <h3>Ready to Ship</h3>
                            <p class="text-muted">You can use the same course material as is, or you can make changes!</p>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 text-center">
                        <div class="service-box">
                    ...
                    <div class="col-lg-3 col-md-6 text-center">
                        <div class="service-box">
                            ...
                            <p class="text-muted">You have to make your courses with love these days!</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section class="bg-primary" id="contact">
            <div class="container">
                <div class="row">
                    <div class="col-lg-8 col-lg-offset-2 text-center">
                        <h2 class="section-heading shadow">Need Support? Found A Bug? Lets Chat!</h2>
                        <hr class="primary">
                        <p class="shadow">We want to keep all the bugs out of Teacherati, please submit your issues to this e-mail below!</p>
                    </div>
                    <div class="col-lg-4 col-lg-offset-2 text-center">
                        <i class="fa fa-phone fa-3x wow bounceIn"></i>
                        <p style="color: #FFFFFF;">(555)555-5555</p>
                    </div>
                    <div class="col-lg-4 text-center">
                        <i class="fa fa-envelope-o fa-3x wow bounceIn" data-wow-delay=".1s"></i>
                        <p><a href="mailto:your-email@your-domain.com" style="color: #FFFFFF;">CORSER'S E-MAIL GOES HERE!</a></p>
                    </div>
                </div>
            </div>
            <!--OPTIONAL <br /><center><a href="#page-top" class="btn btn-default btn-xl text-center">Back To Top</a></center> -->
        </section>
        <!-- Modal -->
                ...
                <div class="modal-content" style="margin-top: 30%; max-width: 50%; left: 25%;">
                    ...
                    <div class="modal-body">
                        <?php
                            ...
                            '.$error.'
                            <button type="submit" name="loginSubmit" style="width: 100%;" class="btn btn-primary">Submit</button>
                            </form>';
                            ?>
                    </div>
